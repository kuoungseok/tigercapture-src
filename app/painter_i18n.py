...
_ROWS: tuple[tuple[str, str, str, str, str, str], ...] = (
    ...
    ("Active Artboard", "활성 아트보드", "アクティブアートボード", "活动画板", "Plan de travail actif", "Aktive Zeichenfläche"),
    ("All Artboards", "모든 아트보드", "すべてのアートボード", "所有画板", "Tous les plans de travail", "Alle Zeichenflächen"),
    ("PPT Preflight", "PPT 사전 검사", "PPT プリフライト", "PPT 预检", "Prévol PPT", "PPT-Vorprüfung"),
    ("Send to PPT", "PPT로 보내기", "PPT に送る", "发送到 PPT", "Envoyer vers PPT", "An PPT senden"),
    ("Convert to Paint", "페인트로 변환", "ペイントに変換", "转换为绘画", "Convertir en peinture", "In Paint konvertieren"),
    ("Convert to Vector", "벡터로 변환", "ベクターに変換", "转换为矢量", "Convertir en vecteur", "In Vektor konvertieren"),
    ("Render the selection as an editable Paint image layer", "선택 항목을 편집 가능한 페인트 이미지 레이어로 렌더링", "選択範囲を編集可能なペイント画像レイヤーとしてレンダリング", "将所选内容渲染为可编辑的绘画图像图层", "Rendre la sélection comme calque d’image modifiable", "Auswahl als bearbeitbare Paint-Bildebene rendern"),
    ("Turn compatible shapes into editable Vector Networks", "호환 도형을 편집 가능한 벡터 네트워크로 변환", "対応するシェイプを編集可能なベクターネットワークに変換", "将兼容形状转换为可编辑的矢量网络", "Transformer les formes compatibles en réseaux vectoriels modifiables", "Kompatible Formen in bearbeitbare Vektornetzwerke umwandeln"),
    ...
    ("Tools", "도구", "ツール", "工具", "Outils", "Werkzeuge"),
    ("Main menu", "메인 메뉴", "メインメニュー", "主菜单", "Menu principal", "Hauptmenü"),
    ("Variables", "변수", "変数", "变量", "Variables", "Variablen"),
    ("Search tools", "도구 검색", "ツールを検索", "搜索工具", "Rechercher des outils", "Werkzeuge suchen"),
    ("Plugins, widgets and extensions appear here.", "플러그인, 위젯 및 확장 도구가 여기에 표시됩니다.", "プラグイン、ウィジェット、拡張機能がここに表示されます。", "插件、小组件和扩展工具会显示在这里。", "Les plugins, widgets et extensions apparaissent ici.", "Plugins, Widgets und Erweiterungen werden hier angezeigt."),
    ("No tools installed", "설치된 도구 없음", "インストール済みツールなし", "未安装工具", "Aucun outil installé", "Keine Werkzeuge installiert"),
    ("No variables", "변수 없음", "変数なし", "无变量", "Aucune variable", "Keine Variablen"),
    ("Actions...", "액션...", "アクション...", "操作...", "Actions...", "Aktionen..."),
    ("New", "신규", "新規", "新建", "Nouveau", "Neu"),
    ("New Design...", "새 디자인...", "新しいデザイン...", "新建设计...", "Nouveau design...", "Neues Design..."),
    ("Blank UI Design...", "빈 UI 디자인...", "空の UI デザイン...", "空白 UI 设计...", "Design UI vierge...", "Leeres UI-Design..."),
    ("From Template...", "템플릿에서 시작...", "テンプレートから...", "从模板开始...", "Depuis un modèle...", "Aus Vorlage..."),
    ("Paint Canvas...", "페인트 캔버스...", "ペイントキャンバス...", "绘画画布...", "Canevas de peinture...", "Mal-Leinwand..."),
    ("Place Image...", "이미지 배치...", "画像を配置...", "置入图像...", "Placer une image...", "Bild platzieren..."),
    ("Save Local Copy...", "로컬 복사본 저장...", "ローカルコピーを保存...", "保存本地副本...", "Enregistrer une copie locale...", "Lokale Kopie speichern..."),
    ("Text", "텍스트", "テキスト", "文本", "Texte", "Text"),
    ("Text Tool", "텍스트 도구", "テキストツール", "文本工具", "Outil texte", "Textwerkzeug"),
    ("Arrange", "정렬", "整列", "排列", "Organiser", "Anordnen"),
    ("Plugins", "플러그인", "プラグイン", "插件", "Plugins", "Plugins"),
    ("Widgets", "위젯", "ウィジェット", "小组件", "Widgets", "Widgets"),
    ("Preferences", "기본 설정", "環境設定", "偏好设置", "Préférences", "Einstellungen"),
    ("Browse Tools", "도구 찾아보기", "ツールを参照", "浏览工具", "Parcourir les outils", "Werkzeuge durchsuchen"),
    ("Libraries", "라이브러리", "ライブラリ", "库", "Bibliothèques", "Bibliotheken"),
    ("Open Libraries", "라이브러리 열기", "ライブラリを開く", "打开库", "Ouvrir les bibliothèques", "Bibliotheken öffnen"),
    ("Help and account", "도움말 및 계정", "ヘルプとアカウント", "帮助和账户", "Aide et compte", "Hilfe und Konto"),
    ...
    ("Focus canvas", "캔버스 집중 모드", "キャンバス集中モード", "画布专注模式", "Mode canevas", "Canvas-Fokusmodus"),
    ("Exit focus canvas", "집중 모드 나가기", "集中モードを終了", "退出专注模式", "Quitter le mode canevas", "Canvas-Fokusmodus beenden"),
    ("Free", "무료", "無料", "免费", "Gratuit", "Kostenlos"),
    ...
    ("Select layer", "레이어 선택", "レイヤーを選択", "选择图层", "Sélectionner le calque", "Ebene auswählen"),
    ("Locked layer", "잠긴 레이어", "ロックされたレイヤー", "锁定图层", "Calque verrouillé", "Gesperrte Ebene"),
    ...
    ("Untitled", "제목 없음", "名称未設定", "未命名", "Sans titre", "Unbenannt"),
    ...
    ("Performance Budget...", "성능 예산...", "パフォーマンス予算...", "性能预算...", "Budget de performance...", "Leistungsbudget..."),
    ("Performance budget", "성능 예산", "パフォーマンス予算", "性能预算", "Budget de performance", "Leistungsbudget"),
    ("No performance budget report available.", "성능 예산 보고서가 없습니다.", "パフォーマンス予算レポートはありません。", "没有性能预算报告。", "Aucun rapport de budget de performance.", "Kein Leistungsbudgetbericht verfügbar."),
    ("Metric", "항목", "指標", "指标", "Mesure", "Metrik"),
    ("Warning", "경고", "警告", "警告", "Avertissement", "Warnung"),
    ("Block", "차단선", "ブロック", "阻断", "Blocage", "Blockieren"),
    ("Objects", "객체", "オブジェクト", "对象", "Objets", "Objekte"),
    ("Artboards", "아트보드", "アートボード", "画板", "Plans de travail", "Artboards"),
    ("Images", "이미지", "画像", "图像", "Images", "Bilder"),
    ("Prototype transitions", "프로토타입 전환", "プロトタイプ遷移", "原型转场", "Transitions de prototype", "Prototyp-Übergänge"),
    ("Hierarchy depth", "계층 깊이", "階層の深さ", "层级深度", "Profondeur de hiérarchie", "Hierarchietiefe"),
    ("Within budget", "예산 이내", "予算内", "预算内", "Dans le budget", "Im Budget"),
    ("Refresh", "새로고침", "更新", "刷新", "Actualiser", "Aktualisieren"),
    ("{covered}/{total} budgets covered · {warning} warning · {blocked} blocked", "예산 {covered}/{total}개 정상 · 경고 {warning}개 · 차단 {blocked}개", "予算 {covered}/{total} 対応 · 警告 {warning} · ブロック {blocked}", "预算 {covered}/{total} 正常 · 警告 {warning} · 阻断 {blocked}", "{covered}/{total} budgets couverts · {warning} avertissement · {blocked} blocage", "{covered}/{total} Budgets abgedeckt · {warning} Warnung · {blocked} blockiert"),
    ("This report checks document scale. Wall-clock rendering performance is measured by separate runtime QA.", "이 보고서는 문서 규모를 검사합니다. 실제 렌더링 시간은 별도 런타임 QA에서 측정합니다.", "このレポートはドキュメント規模を検査します。実レンダリング時間は別のランタイムQAで測定します。", "此报告检查文档规模。实际渲染耗时由独立运行时 QA 测量。", "Ce rapport vérifie l'échelle du document. Le temps de rendu est mesuré par un QA séparé.", "Dieser Bericht prüft den Dokumentumfang. Die reale Renderzeit misst eine separate Laufzeit-QA."),
    ("Runtime Performance...", "런타임 성능...", "ランタイム性能...", "运行时性能...", "Performance d'exécution...", "Laufzeitleistung..."),
    ("Runtime performance", "런타임 성능", "ランタイム性能", "运行时性能", "Performance d'exécution", "Laufzeitleistung"),
    ("Run the local runtime benchmark.", "로컬 런타임 벤치마크를 실행하세요.", "ローカルランタイムベンチマークを実行します。", "运行本地运行时基准测试。", "Exécutez le benchmark local.", "Lokalen Laufzeit-Benchmark ausführen."),
    ("Path", "경로", "パス", "路径", "Chemin", "Pfad"),
    ("Median", "중앙값", "中央値", "中位数", "Médiane", "Median"),
    ("Run benchmark", "벤치마크 실행", "ベンチマークを実行", "运行基准测试", "Exécuter le benchmark", "Benchmark ausführen"),
    ("Running local benchmark...", "로컬 벤치마크 실행 중...", "ローカルベンチマークを実行中...", "正在运行本地基准测试...", "Benchmark local en cours...", "Lokaler Benchmark läuft..."),
    ("Results describe this machine only and are not a universal performance claim.", "결과는 이 컴퓨터만 설명하며 보편적인 성능 주장이 아닙니다.", "結果はこのマシンのみを示し、普遍的な性能主張ではありません。", "结果仅描述此计算机，并非通用性能声明。", "Les résultats décrivent uniquement cette machine.", "Die Ergebnisse gelten nur für diesen Rechner."),
    ("Normalize document", "문서 정규화", "ドキュメント正規化", "文档规范化", "Normaliser le document", "Dokument normalisieren"),
    ...
    ("Screen Design", "화면 디자인", "画面デザイン", "屏幕设计", "Design d’écran", "Bildschirmdesign"),
    ("Interactive Prototype", "인터랙티브 프로토타입", "インタラクティブプロトタイプ", "交互式原型", "Prototype interactif", "Interaktiver Prototyp"),
    ("Describe a screen, component, or product UI", "화면, 컴포넌트 또는 제품 UI를 설명하세요", "画面、コンポーネント、製品 UI を説明してください", "描述屏幕、组件或产品 UI", "Décrivez un écran, un composant ou une interface produit", "Beschreiben Sie einen Bildschirm, eine Komponente oder Produkt-UI"),
    ("Plan and Preview", "계획 및 미리보기", "計画とプレビュー", "规划并预览", "Planifier et prévisualiser", "Planen und Vorschau"),
    ("No AI plan", "AI 계획 없음", "AI 計画なし", "无 AI 计划", "Aucun plan IA", "Kein KI-Plan"),
    ("Apply Approved Plan", "승인한 계획 적용", "承認した計画を適用", "应用已批准的计划", "Appliquer le plan approuvé", "Genehmigten Plan anwenden"),
    ("Run Product QA", "제품 QA 실행", "製品 QA を実行", "运行产品 QA", "Exécuter le QA produit", "Produkt-QA ausführen"),
    ("Explicit apply required", "명시적 적용 필요", "明示的な適用が必要", "需要明确应用", "Application explicite requise", "Explizite Anwendung erforderlich"),
    ("Ready", "준비됨", "準備完了", "就绪", "Prêt", "Bereit"),
    ("Blocked", "차단됨", "ブロック", "已阻止", "Bloqué", "Blockiert"),
    ("{objects} objects · {covered}/{total} paths covered · {warning} warning · {blocked} blocked", "객체 {objects}개 · 경로 {covered}/{total}개 정상 · 경고 {warning}개 · 차단 {blocked}개", "オブジェクト {objects} · パス {covered}/{total} 対応 · 警告 {warning} · ブロック {blocked}", "对象 {objects} · 路径 {covered}/{total} 正常 · 警告 {warning} · 阻断 {blocked}", "{objects} objets · {covered}/{total} chemins couverts · {warning} avertissement · {blocked} blocage", "{objects} Objekte · {covered}/{total} Pfade abgedeckt · {warning} Warnung · {blocked} blockiert"),
...
# Correct Korean labels for the Painter UI logo menu.  Kept separate so these
# rows intentionally override corrupted legacy locale imports above.
_UI_MENU_ROWS: tuple[tuple[str, str, str, str, str, str], ...] = tuple(
    (english, korean, english, english, english, english)
    for english, korean in (
        ("Main menu", "메인 메뉴"), ("Actions...", "액션..."),
        ("File", "파일"), ("Edit", "편집"), ("View", "보기"),
        ("New Design...", "새 디자인..."), ("New", "신규"),
        ("Blank UI Design...", "빈 UI 디자인..."),
        ("From Template...", "템플릿에서 시작..."),
        ("Paint Canvas...", "페인트 캔버스..."),
        ("Place Image...", "이미지 배치..."), ("Open...", "열기..."),
        ("Save", "저장"), ("Save Local Copy...", "로컬 복사본 저장..."),
        ("Save to version history...", "버전 내역에 저장..."),
        ("View version history", "버전 내역 보기"),
        ("Export...", "내보내기..."),
        ("Export frames to PDF...", "프레임을 PDF로 내보내기..."),
        ("Create branch...", "브랜치 만들기..."),
        ("Version history", "버전 내역"),
        ("Named versions of this design", "이 디자인의 저장된 버전"),
        ("No saved versions are available.", "저장된 버전이 없습니다."),
        ("Restore version", "버전 복원"),
        ("Save to version history", "버전 내역에 저장"),
        ("Version name", "버전 이름"),
        ("Restore this version? The current state remains undoable.", "이 버전을 복원할까요? 현재 상태는 실행 취소로 되돌릴 수 있습니다."),
        ("Export frames to PDF", "프레임을 PDF로 내보내기"),
        ("PDF export failed", "PDF 내보내기 실패"),
        ("Create branch", "브랜치 만들기"), ("Branch name", "브랜치 이름"),
        ("That branch already exists. Replace it?", "같은 브랜치가 이미 있습니다. 교체할까요?"),
        ("Object", "개체"), ("Text", "텍스트"), ("Arrange", "정렬"),
        ("Vector", "벡터"), ("Preferences", "기본 설정"),
        ("Libraries", "라이브러리"), ("Help and account", "도움말 및 계정"),
        ("Undo", "실행 취소"), ("Redo", "다시 실행"),
        ("Copy format", "복사 형식"), ("Copy properties", "속성 복사"),
        ("Paste properties", "속성 붙여넣기"),
        ("Paste over selection", "선택 항목 위에 붙여넣기"),
        ("Paste to replace", "붙여 넣어 교체"), ("Duplicate", "복제"),
        ("Delete", "삭제"), ("Find", "찾기"),
        ("Find next", "다음 항목 찾기"), ("Find previous", "이전 항목 찾기"),
        ("Find and replace...", "찾기 및 바꾸기..."),
        ("Select all", "모두 선택"),
        ("Select matching layers", "일치하는 레이어 선택"),
        ("Select none", "선택 안 함"), ("Invert selection", "반전 선택"),
        ("Pixel grid", "픽셀 그리드"), ("Layout guides", "레이아웃 가이드"),
        ("Rulers", "눈금자"), ("Pixel preview", "픽셀 미리보기"),
        ("Show navigator", "탐색기 표시"),
        ("Show inspector", "속성 패널 표시"), ("Zoom in", "확대"),
        ("Zoom out", "축소"), ("Zoom to 100%", "100%로 확대"),
        ("Fit to screen", "화면에 맞게 축소/확대"),
        ("Zoom to selection", "선택 영역 확대"),
        ("Select parent", "상위 개체 선택"), ("Group selection", "그룹 선택"),
        ("Ungroup selection", "그룹 해제 선택"),
        ("Wrap in new section", "새로운 섹션으로 감싸기"),
        ("Create component", "컴포넌트 만들기"),
        ("Reset instance", "인스턴스 재설정"),
        ("Detach instance", "인스턴스 분리"),
        ("Bring to front", "맨 앞으로 가져오기"),
        ("Bring forward", "앞으로 가져오기"), ("Send backward", "뒤로 보내기"),
        ("Send to back", "맨 뒤로 보내기"), ("Flip horizontal", "좌우 반전"),
        ("Flip vertical", "상하 반전"), ("Bold", "볼드"),
        ("Italic", "이탤릭체"), ("Underline", "밑줄"),
        ("Strikethrough", "취소선"), ("Alignment", "정렬"),
        ("Letter case", "대문자/소문자"), ("Uppercase", "대문자"),
        ("Lowercase", "소문자"), ("Tidy up", "픽셀에 맞춰 반올림"),
        ("Align left", "왼쪽 정렬"),
        ("Align horizontal centers", "가로 가운데 정렬"),
        ("Align right", "오른쪽 정렬"), ("Align top", "상단 정렬"),
        ("Align vertical centers", "세로 가운데 정렬"),
        ("Align bottom", "하단 정렬"),
        ("Distribute horizontal spacing", "가로 간격 고르게 분배"),
        ("Distribute vertical spacing", "세로 간격 분배"),
        ("Boolean operation", "불리언 연산"),
        ("Union selection", "선택 항목 결합"),
        ("Subtract selection", "선택 항목 빼기"),
        ("Intersect selection", "선택 항목 교차"),
        ("Exclude selection", "선택 항목 제외"),
        ("Convert to vector", "벡터로 변환"),
        ("Snap to geometry", "기하학에 맞추기"),
        ("Highlight layers on hover", "마우스를 올릴 때 레이어 강조 표시"),
        ("Rename duplicated layers", "중복된 레이어 이름 변경"),
        ("Show object dimensions", "개체에 치수 표시"),
        ("Use smart quotes", "스마트 따옴표/기호 사용"),
        ("Use scroll wheel to zoom", "스크롤 휠로 줌 사용"),
        ("Right-click and drag to pan", "우클릭하고 드래그하여 이동"),
    )
)
_FOCUS_ZOOM_ROWS: tuple[tuple[str, str, str, str, str, str], ...] = (
    ("UMG Widget View", "UMG 위젯 보기", "UMGウィジェット表示", "UMG 小组件视图", "Vue des widgets UMG", "UMG-Widget-Ansicht"),
    ("Source Design", "원본 디자인", "ソースデザイン", "源设计", "Design source", "Quelldesign"),
    ("Painter canonical", "Painter 원본", "Painter原本", "Painter 原稿", "Source Painter", "Painter-Quelle"),
    ("Editable selection", "선택 가능", "選択可能", "可选择", "Sélection modifiable", "Auswahl möglich"),
    ("Move and resize", "이동 및 크기 조절", "移動とサイズ変更", "移动和调整大小", "Déplacer et redimensionner", "Verschieben und skalieren"),
    ("UMG Widgets", "UMG 위젯", "UMGウィジェット", "UMG 小组件", "Widgets UMG", "UMG-Widgets"),
    ("TigerStudioUMG simulated", "TigerStudioUMG 모사", "TigerStudioUMGシミュレーション", "TigerStudioUMG 模拟", "Simulation TigerStudioUMG", "TigerStudioUMG-Simulation"),
    ("Locked UMG projection", "잠긴 UMG 결과", "ロックされたUMG結果", "锁定的 UMG 结果", "Projection UMG verrouillée", "Gesperrte UMG-Projektion"),
    ("Edit the source - UMG follows live", "원본 편집 · UMG 실시간 반영", "ソース編集・UMGへ即時反映", "编辑源，UMG 实时同步", "Modifier la source · UMG suit en direct", "Quelle bearbeiten · UMG folgt live"),
    ("UMG Layout", "UMG 레이아웃", "UMGレイアウト", "UMG 布局", "Disposition UMG", "UMG-Layout"),
    ("Select an object on the left", "왼쪽에서 객체 선택", "左側でオブジェクトを選択", "在左侧选择对象", "Sélectionnez un objet à gauche", "Links ein Objekt auswählen"),
    ("Drag the widget or its corner handles", "위젯 본체 또는 모서리 핸들을 드래그", "ウィジェット本体または角ハンドルをドラッグ", "拖动小组件或其角点手柄", "Faites glisser le widget ou ses poignées d’angle", "Widget oder Eckgriffe ziehen"),
    ("Anchors preserve the current layout at this parent size", "앵커 변경 시 현재 부모 크기에서는 배치를 유지", "アンカー変更時も現在の親サイズでは配置を維持", "更改锚点时保留当前父级尺寸下的布局", "Les ancres conservent la disposition pour cette taille parente", "Anker behalten das Layout bei dieser Elterngröße bei"),
    ("Position", "위치", "位置", "位置", "Position", "Position"),
    ("Size", "크기", "サイズ", "大小", "Taille", "Größe"),
    ("Horizontal Anchor", "가로 앵커", "水平アンカー", "水平锚点", "Ancrage horizontal", "Horizontaler Anker"),
    ("Vertical Anchor", "세로 앵커", "垂直アンカー", "垂直锚点", "Ancrage vertical", "Vertikaler Anker"),
    ("Alignment / Pivot", "정렬 / 피벗", "整列 / ピボット", "对齐 / 轴心", "Alignement / pivot", "Ausrichtung / Pivot"),
    ("Locked", "잠김", "ロック", "已锁定", "Verrouillé", "Gesperrt"),
    ("Left", "왼쪽", "左", "左", "Gauche", "Links"),
    ("Right", "오른쪽", "右", "右", "Droite", "Rechts"),
    ("Top", "위", "上", "上", "Haut", "Oben"),
    ("Bottom", "아래", "下", "下", "Bas", "Unten"),
    ("Scale", "비율", "スケール", "缩放", "Échelle", "Skalieren"),
    ("User profile", "사용자 프로필", "ユーザープロフィール", "用户资料", "Profil utilisateur", "Benutzerprofil"),
    ("Presentation", "프레젠테이션", "プレゼンテーション", "演示", "Présentation", "Präsentation"),
    ("Preview", "미리보기", "プレビュー", "预览", "Aperçu", "Vorschau"),
    ("Zoom in", "확대", "拡大", "放大", "Zoom avant", "Vergrößern"),
    ("Zoom out", "축소", "縮小", "缩小", "Zoom arrière", "Verkleinern"),
    ("Fit all artboards", "화면에 맞게 축소/확대", "全体を画面に合わせる", "适应画面", "Ajuster à l’écran", "An Bildschirm anpassen"),
    ("Pixel preview", "픽셀 미리보기", "ピクセルプレビュー", "像素预览", "Aperçu des pixels", "Pixelvorschau"),
    ("Pixel grid", "픽셀 그리드", "ピクセルグリッド", "像素网格", "Grille de pixels", "Pixelraster"),
    ("Snap to pixel grid", "픽셀 그리드에 맞추기", "ピクセルグリッドに合わせる", "对齐像素网格", "Aligner sur la grille", "Am Pixelraster ausrichten"),
    ("Layout guides", "레이아웃 가이드", "レイアウトガイド", "布局参考线", "Guides de mise en page", "Layout-Hilfslinien"),
    ("Rulers", "눈금자", "ルーラー", "标尺", "Règles", "Lineale"),
    ("Outlines", "윤곽선", "アウトライン", "轮廓", "Contours", "Konturen"),
    ("Multiplayer cursors", "멀티플레이어 커서", "マルチプレイヤーカーソル", "多人光标", "Curseurs multijoueurs", "Mehrspieler-Cursor"),
    ("Additional labels", "추가 레이블", "追加ラベル", "附加标签", "Libellés supplémentaires", "Zusätzliche Beschriftungen"),
    ("Comments", "댓글", "コメント", "评论", "Commentaires", "Kommentare"),
)

_UMG_INTERACTION_ROWS: tuple[
    ...
    (
        "Select a generated Material layer",
        "생성된 Material 레이어를 선택하세요",
        "生成済みのMaterialレイヤーを選択",
        "选择已生成的 Material 图层",
        "Sélectionnez un calque Material généré",
        "Eine erzeugte Material-Ebene auswählen",
    ),
    (
        "Open the generated Custom HLSL material graph",
        "생성된 Custom HLSL 머터리얼 그래프 열기",
        "生成されたCustom HLSLマテリアルグラフを開く",
        "打开已生成的 Custom HLSL 材质图",
        "Ouvrir le graphe Custom HLSL généré",
        "Den erzeugten Custom-HLSL-Materialgraphen öffnen",
    ),
    (
        ...
        "移動・サイズ変更・アンカーのドラッグ",
        "移动、调整大小和拖动锚点",
        "Déplacer, redimensionner et faire glisser les ancres",
        "Verschieben, skalieren und Anker ziehen",
    ),
    (
        "Drag values horizontally or drag the orange anchor",
        "수치는 좌우로, 주황 앵커는 캔버스에서 드래그",
        "数値は左右に、オレンジのアンカーはキャンバス上でドラッグ",
        "左右拖动数值，或在画布上拖动橙色锚点",
        "Glissez les valeurs horizontalement ou l’ancre orange",
        "Werte horizontal oder den orangefarbenen Anker ziehen",
    ),
    (
        "Drag horizontally - Shift fine - Ctrl fast - click to type",
        "좌우 드래그 · Shift 정밀 · Ctrl 빠르게 · 클릭해 직접 입력",
        "左右ドラッグ・Shiftで微調整・Ctrlで高速・クリックで入力",
        "左右拖动 · Shift 微调 · Ctrl 快速 · 单击输入",
        "Glisser horizontalement · Maj précis · Ctrl rapide · cliquer pour saisir",
        "Horizontal ziehen · Umschalt fein · Strg schnell · klicken zum Eingeben",
    ),
    (
        "Drag the orange anchor to set UMG Min/Max",
        "주황 앵커를 드래그해 UMG Min/Max 설정",
        "オレンジのアンカーをドラッグして UMG Min/Max を設定",
        "拖动橙色锚点以设置 UMG Min/Max",
        "Glissez l’ancre orange pour définir Min/Max UMG",
        "Orangefarbenen Anker ziehen, um UMG Min/Max festzulegen",
    ),
)

_ROWS = _ROWS + _UI_MENU_ROWS + _FOCUS_ZOOM_ROWS + _UMG_INTERACTION_ROWS
...
class PainterWidgetLocalizer(QObject):
    ...
    def _translate_object(self, obj: QObject) -> None:
        if bool(obj.property("painterI18nLocked")):
            return
