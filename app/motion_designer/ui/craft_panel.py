...
class CraftStylePanel(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        specs = (
            ...
            ("grain_chroma", "Grain Color", 0.0, 1.0, 0.01, 2),
            ("grain_shadow_response", "Grain Shadows", 0.0, 2.0, 0.05, 2),
            ("grain_midtone_response", "Grain Midtones", 0.0, 2.0, 0.05, 2),
            ("grain_highlight_response", "Grain Highlights", 0.0, 2.0, 0.05, 2),
            ...
            ("dust_lifetime", "Dust Life (s)", 0.04, 10.0, 0.05, 2),
            ("scratch_amount", "Scratches", 0.0, 1.0, 0.01, 3),
            ("scratch_direction", "Scratch Angle", -180.0, 180.0, 1.0, 1),
            ...
            ("edge_fiber_amount", "Edge Fibers", 0.0, 1.0, 0.01, 3),
            ("edge_fiber_length", "Fiber Length", 1.0, 64.0, 1.0, 1),
