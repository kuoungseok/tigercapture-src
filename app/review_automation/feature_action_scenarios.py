...
def default_feature_action_scenarios() -> tuple[FeatureActionScenario, ...]:
    ...
    return (
        ...
        _scenario(
            ...
            "multilingual_ui",
            "Drive a multilingual caption/UI review surface with locale labels and font-safe screenshot output.",
            (
                _step("media.import_to_timeline", {"path": "$overview_video", "kind": "video", "track_id": 1, "at_ms": 0, "duration_ms": 6000}),
                _step("timeline.marker.add", {"ms": 1000, "label": "locale sweep", "color": "#B9FF66"}),
                _step("text.add", {"track_id": 1, "clip_id": 1, "text": "KO / EN / JA / ZH / FR / DE", "start_ms": 0, "end_ms": 5000, "style": {"position_y": 0.82}}),
                _step("ui.focus_surface", {"surface": "timeline", "kind": "video", "track_id": 1, "clip_id": 1, "inspector_tab": "clip"}),
                _step("capture.screenshot", {"path": "$feature_capture_path", "target": "editor"}),
            ),
        ),
        ...
        _scenario(
            ...
            (
                ...
                _step("audio.track.set_mix", {"track_id": 2, "volume": 0.82, "pan": -0.05}),
