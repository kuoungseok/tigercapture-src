...
def default_review_features() -> tuple[ReviewFeature, ...]:
    return (
        ...
        ReviewFeature(
            id="multilingual_ui",
            title="Six-Language Runtime UI",
            category="Localization",
            summary="Korean, English, Japanese, Simplified Chinese, French, and German locale tables are audited for missing keys, mojibake, and placeholder mismatches.",
            claim="TigerCapture can show a serious multilingual UI foundation rather than a single-language prototype.",
            qa_reports=("debugCapture/localization_audit_qa.json",),
            priority=25,
            tags=("i18n", "localization", "multilingual", "qa"),
            guardrails=("Voice translation/dubbing remains a separate CapCut Voice workflow claim until provider coverage is product-complete.",),
        ),
        ReviewFeature(
            id="live2d_overlay",
