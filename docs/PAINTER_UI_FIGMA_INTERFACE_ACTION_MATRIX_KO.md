...
| Object geometry and hierarchy | Canvas selection/marquee/resize, Layers reorder/reparent/group, ancestor breadcrumb, Alt-click overlap cycle | `paint.ui.object.*`, `paint.ui.selection.set/parent/deep_select` |
