...
def test_final_product_readiness_accepts_broadcast_platform_evidence(tmp_path):
    ...
    (tmp_path / "debugCapture" / "broadcast_platform_e2e_qa.json").write_text(
        json.dumps({
            ...
            "checks": [
                {"id": "record_file_local", "kind": "local_runtime", "ok": True},
                {"id": "capture_composite_local", "kind": "local_runtime", "ok": True},
                {"id": "private_rtmp_ingest", "kind": "real_platform", "ok": True},
                {"id": "discord_window_share", "kind": "real_platform", "ok": True},
            ],
        }),
        encoding="utf-8",
    )
